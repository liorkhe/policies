...
| net_software_stack_sut | sut1: Linux Kernel TCP stack v.XXX, sut2: Linux Kernel TCP stack v.YYY  
| network_topology | Loadgen System connected to 2 SUTs through 24x100GE Switch XXX of manufacture YYY and Load Balancer ZZZ of manufacture SSS, each connected to a 100GE port
|===
